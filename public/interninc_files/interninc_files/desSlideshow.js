...
(function(a){
    a.fn.desSlideshow=function(p){
        ...
        function init(){
            ...
            g.find(".nav").children("li").css("height","49px").css("background","url("+directory+"flashtext-bg.jpg)").css("line-height","49px").css("border-bottom","1px solid #CCCCCC").css("border-right","1px solid #CCCCCC");
